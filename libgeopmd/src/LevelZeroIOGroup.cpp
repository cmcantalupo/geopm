...
namespace geopm
{
    ...
    LevelZeroIOGroup::LevelZeroIOGroup(const PlatformTopo &platform_topo,
        ...
        , m_signal_available({{M_NAME_PREFIX + "GPU_CORE_FREQUENCY_STATUS", {
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_RESET_COUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_reset_count(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_PROGRAMMING_ERRCOUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_programming_errcount(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_DRIVER_ERRCOUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_driver_errcount(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_COMPUTE_ERRCOUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_compute_errcount(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_NONCOMPUTE_ERRCOUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_noncompute_errcount(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_CACHE_ERRCOUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_cache_errcount(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_DISPLAY_ERRCOUNT", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_display_errcount(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
        ...
        , m_mock_save_ctl(std::move(save_control_test))
    {
        ...
        for (auto &sv : m_signal_available) {
            ...
            for (int domain_idx = 0; domain_idx < m_platform_topo.num_domain(
                ...
                try {
                    ...
                    if (sv.first.find("_PERFORMANCE_") != std::string::npos) {
        ...
        register_signal_alias("GPU_CORE_RAS_RESET_COUNT", M_NAME_PREFIX + "GPU_CORE_RAS_RESET_COUNT");
        register_signal_alias("GPU_CORE_RAS_PROGRAMMING_ERRCOUNT", M_NAME_PREFIX + "GPU_CORE_RAS_PROGRAMMING_ERRCOUNT");
        register_signal_alias("GPU_CORE_RAS_DRIVER_ERRCOUNT", M_NAME_PREFIX + "GPU_CORE_RAS_DRIVER_ERRCOUNT");
        register_signal_alias("GPU_CORE_RAS_COMPUTE_ERRCOUNT", M_NAME_PREFIX + "GPU_CORE_RAS_COMPUTE_ERRCOUNT");
        register_signal_alias("GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT", M_NAME_PREFIX + "GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT");
        register_signal_alias("GPU_CORE_RAS_CACHE_ERRCOUNT", M_NAME_PREFIX + "GPU_CORE_RAS_CACHE_ERRCOUNT");
        register_signal_alias("GPU_CORE_RAS_DISPLAY_ERRCOUNT", M_NAME_PREFIX + "GPU_CORE_RAS_DISPLAY_ERRCOUNT");
    ...
    void LevelZeroIOGroup::save_control(void)
    {
        for (int domain_idx = 0;
            ...
            if (m_control_available.find("GPU_CORE_PERFORMANCE_FACTOR_CONTROL") != m_control_available.end()) {
                try {
                    // Currently only the levelzero compute domain control is supported.
                    // As new controls are added they should be included
