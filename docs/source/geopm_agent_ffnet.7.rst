...
This agent requires a directory specified by the environment variable ``GEOPM_FFNET_PATH``.
...
If you specify a neural net file for a domain (CPU/GPU), you must also provide a corresponding frequency recommendation file.
